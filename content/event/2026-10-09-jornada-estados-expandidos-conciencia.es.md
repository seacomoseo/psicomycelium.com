...
cancelled: false
artists:
- name: Amanda Argüelles
- name: Xemi (Pluma Roja)
- name: Fran Rivero
- name: Arosa J.Q.
- name: Tote Escobedo
- name: Leon
...
- name: Oscar
- name: Elsa Navarra
- name: Eric Haas y Chiara Vitali
...
- name: Inoé
- name: Espacio PsyCare · Colectivo La Nave
- name: BabaYaga Ferments
- name: Pau
- name: Paula
address:
  locality: Valencia
...
mapa_viaje:
  ...
  md: |
    ...
    Por eso hemos querido que estas jornadas sigan el mismo ritmo con el que la naturaleza despliega la vida. Nos inspiramos en los **Cinco Elementos (Wu Xing)** de la filosofía taoísta para recorrer juntos un camino que va desde la apertura hasta la integración.
  boxes:

  - id: mapa-viaje-viernes
...
artistas:
  title: Artistas · Vibraciones del Micelio
  sub: Paisajes sonoros, ritmo y meditación en vivo
  boxes:
...
formulario:
  ...
  sub: Completa tus datos y selecciona tus preferencias
  inputs:
  ...
  - type: area
    ...
    label: ¿Cómo conociste Psico Mycelium?
    icon: search
    req: true
